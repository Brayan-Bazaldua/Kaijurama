...
const tituloJuego = document.querySelector('#pantalla-inicio h1');
...
btnMute.addEventListener('click', () => {
    ...
    btnMute.src = todoMuteado ? 'img/soundoff.png' : 'img/soundon.png';
    btnMute.alt = todoMuteado ? 'soundoff' : 'soundon';
    btnMute.title = todoMuteado ? 'soundoff' : 'soundon';
